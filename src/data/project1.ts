...
export const project1: ProjectDetail = {
      ...
      details: [
        ...
        },
        {
          ...
          detail: [
            ...
            '세션스토리지에 스크롤 위치를 저장하여 동화 클릭 후 뒤로 가기 시 이전 스크롤 위치를 유지해 사용자가 자연스럽게 이전 상태로 돌아갈 수 있도록 구현했습니다.',
          ],
        },
      ],
    },
  ...
  collaboration: [
    ...
    },
    {
      ...
      detail: [
        'WBS, 스토리보드, 플로우차트 작성 등 기획 및 디자인 작업에 참여하여 프로젝트의 전반적인 흐름을 이해하고, 개발 과정에서의 목표와 역할을 체계적으로 관리했습니다.',
      ],
    },
    {
      feature: 'Swagger를 통한 API 문서화 및 소통 개선',
      detail: [
        'Swagger를 사용해 API 명세서를 작성하여 API 형식에 대한 명확한 이해와 함께 팀원 간의 소통을 개선했습니다.',
      ],
    },
  ],
  trouble: [
